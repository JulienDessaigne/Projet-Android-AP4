...
public interface InterfacePraticien {
    ...
    @GET("lesmedcins_par_depart.php?libelledepartement={libelledepartement}")
    Call<ArrayList<Praticien>> lesPraticiensParDepart(@Path("libelledepartement") String libelleDepartement);
